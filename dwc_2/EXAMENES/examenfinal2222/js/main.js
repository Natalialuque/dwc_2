...
window.onload = function() {
    ...
    if (LocalUtils.existeLocal("loginGuardado")) {
        mensajeLogin.textContent = "Bienvenido, " + LocalUtils.getLocal("loginGuardado");
    } else {
...
registro.onclick=function(){
    ...
    botonEnviar.onclick = function () {
        ...
        if (valido) {
            ...
            //guardamos 
            LocalUtils.setLocal("loginGuardado",inputLogin.value.trim());
